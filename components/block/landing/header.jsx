...
export default function Header() {
  ...
  return (
    <div id="header" className="fixed top-0 left-0 right-0 flex-col z-50">
      <div className="flex justify-between items-center w-full lg:max-w-screen-lg py-2 mx-auto bg-white">
        <div className="mt-8">
          <Link href="/">
        ...
        <div className="relative flex text-sm font-regular text-neutral-600">
          ...
          >
            <div className="flex gap-7">
              <Link
                href="/products"
                className="transition-colors duration-500 hover:text-black mt-8"
              >
                Products
              </Link>
              <Link
      ...
      <div className="flex bg-gradient-to-b from-white to-transparent w-full mpt-4 h-[14vh]"></div>
    </div>
  );
}
