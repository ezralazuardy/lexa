...
export default function HeroTitle() {
  return (
    <div className="flex flex-col items-center justify-center w-full px-8 md:px-0">
      <h1
        className={`w-full text-4xl md:text-5xl font-regular text-[#171717] text-start md:text-center leading-none ${Open_Sans.className}`}
      >
        Legal
      </h1>
      <p className="w-full text-sm md:text-md font-light text-neutral-600 text-justify md:text-center leading-snug mt-6 md:mt-8 md:max-w-xl">
